...
[![CI](https://github.com/UKPLab/arxiv2026-instruction-vectors/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/arxiv2026-instruction-vectors/actions/workflows/main.yml)
...
To import classes/methods of `arxiv2026_instruction_vectors` from inside the package itself you can use relative imports: 
...
```py
from arxiv2026_instruction_vectors import BaseClass # Notice how I omit the file name
from arxiv2026_instruction_vectors.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2026_instruction_vectors` from command line:

```bash
$ python -m arxiv2026_instruction_vectors
```
